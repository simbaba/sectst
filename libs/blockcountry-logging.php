...
function iqblockcountry_logging($ipaddress,$country,$banend)
{
    ...
    $urlRequested = (isset($_SERVER["REQUEST_URI"]) ? urldecode($_SERVER["REQUEST_URI"]) : '/' );

    $table_name = $wpdb->prefix . "iqblock_logging";
    $wpdb->query("INSERT INTO " . $table_name . " (datetime, ipaddress, country, banned, url) VALUES ('" . current_time('mysql') . "', '" . $ipaddress ."', '" . $country . "', '" . $banend . "', '" . $urlRequested . "')");
}
